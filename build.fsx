...
let summary = "Library for the FSharp friendly usage of the ML.NET project"

// Longer description of the project
// (used as a description for NuGet package; line breaks are automatically cleaned up)
let description = "Library for the FSharp friendly usage of the ML.NET project"

// List of author names (for NuGet package)
let author = "Timo Mühlhaus"

// Tags for your project (for NuGet package)
let tags = "ML ML.NET FSharp F# machine lerning AI"
...
let info =
  [ "project-name", "FSharpML"
    "project-author", "Timo Mühlhaus"
    "project-summary", "Library for the FSharp friendly usage of the ML.NET project"
    "project-github", githubLink
    "project-nuget", "http://nuget.org/packages/FSharpML" ]
