        ...
        static member InitPermutationFeatureImportance
            (
                ...
                fun (data:IDataView) (transformerModel:TransformerModel.TransformerModel<_>) ->                                       
                    ...
                    transformerModel.Context.BinaryClassification.PermutationFeatureImportance(transformerModel.TransformerChain.LastTransformer,prediction,label,features,useFeatureWeightFilter,topExamples,permutationCount)
    ...
    type MulticlassClassification =
        ...
        static member InitPermutationFeatureImportance
            (
                ...
                fun (data:IDataView) (transformerModel:TransformerModel.TransformerModel<_>) ->                                       
                    let prediction = transformerModel |> TransformerModel.transform data
                    transformerModel.Context.MulticlassClassification.PermutationFeatureImportance(transformerModel.TransformerChain.LastTransformer,prediction,label,features,useFeatureWeightFilter,topExamples,permutationCount)
    ...
    type Regression =
        ...
        static member InitPermutationFeatureImportance
            (
                ...
                fun (data:IDataView) (transformerModel:TransformerModel.TransformerModel<_>) ->                                       
                    let prediction = transformerModel |> TransformerModel.transform data
                    transformerModel.Context.Regression.PermutationFeatureImportance(transformerModel.TransformerChain.LastTransformer,prediction,label,features,useFeatureWeightFilter,topExamples,permutationCount)
    ...
    type Ranking =
        ...
        static member InitPermutationFeatureImportance
            (
                ...
                fun (data:IDataView) (transformerModel:TransformerModel.TransformerModel<_>) ->                                       
                    let prediction = transformerModel |> TransformerModel.transform data
                    transformerModel.Context.Ranking.PermutationFeatureImportance(transformerModel.TransformerChain.LastTransformer,prediction,label,groupID,features,useFeatureWeightFilter,topExamples)
